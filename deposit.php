            ...
            <div wire:id="wOmfdIHyTPoGj5fFFC4Y">
                ...
                <div class="row" x-data="">
                    ...
                    <div class="col-6 col-xl-3 ">
                        <!-- Card -->
                        <a href="#" onclick="handleClick(event, 'USTDTRC20', 1)" class="card border border-3 border-primary">
                            <div class="card-body">
                                ...
                                <!-- Title -->
                                <h3 class="card-title mt-3 mb-0 text-dark"> USTD TRC20</h3>
                                <span class="text-muted m-0 p-0">Pay via USTD TRC20</span>
                            </div>
                        </a>
                    </div>
