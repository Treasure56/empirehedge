        ...
        i &&
          (async () => {
            ...
            let u = document.getElementById("draggable"),
              ...
              S = null,
              D = c().startOf("day"),
              O = D.clone().subtract(1, "day").format("YYYY-MM-DD"),
              ...
              I = new e(i, {
                ...
                viewDidMount: () => {
                  i.querySelector(".fc-customToday-button").classList.add(
                    "btn-light"
                  );
                },
                eventClick: (e) => {
  ...
  (r.m = s),
        ...
        t.forEach((e) => {
          ...
          "radio" == e.type
            ...
            e.addEventListener("change", (n) => {
              localStorage[t] =
                "radio" == e.type ? n.target.value : n.target.checked;
            });
        }),
    ...
    (() => {
      ...
      function Z(e) {
        return "html" === T(e)
          ? e
          : e.assignedSlot || e.parentNode || (O(e) ? e.host : null) || Y(e);
      }
      function W(e) {
      ...
      function R(e) {
        for (var t = x(e), n = W(e); n && F(n) && "static" === H(n).position; )
          n = W(n);
        return n &&
          ("html" === T(n) || ("body" === T(n) && "static" === H(n).position))
          ? t
          : n ||
              (function (e) {
        ...
        return t === u
          ...
          : pe(
              (function (e) {
                ...
                return (
                  "rtl" === H(s || n).direction &&
                    (a += $(n.clientWidth, s ? s.clientWidth : 0) - o),
        ...
        var s =
            "clippingParents" === t
              ? (function (e) {
                  var t = he(Z(e)),
                    n =
                      ["absolute", "fixed"].indexOf(H(e).position) >= 0 && D(e)
                        ? R(e)
                        : e;
                  return S(n)
                    ? t.filter(function (e) {
      ...
      function be(e, s) {
        ...
        var o = s,
          ...
          x = e.rects.popper,
          D = e.elements[E ? T : y],
          O = ge(S(D) ? D : D.contextElement || Y(e.elements.popper), m, _, f),
              ...
              return (
                (e[o] = (function (e, n, o) {
                  ...
                  return (
                    (c = c || 0),
                    (d = (d || 0) * a),
                    [s, i].indexOf(r) >= 0 ? { x: d, y: c } : { x: c, y: d }
                  );
                })(o, n.rects, l)),
                e
              );
              ...
              var P,
                ...
                ae = re
                  ? "y" === C
                    ...
                    : re.clientLeft || 0
                  : 0,
                le = null != (P = null == N ? void 0 : N[C]) ? P : 0,
                ce = F + oe - le,
                de = V(_ ? I(Y, F + se - le - ae) : Y, F, _ ? $(Z, ce) : Z);
              (x[C] = de), (j[C] = de - F);
            }
            if (h) {
              var ue,
                ...
                _e = fe - w[pe],
                ve = -1 !== [t, s].indexOf(E),
                ye = null != (ue = null == N ? void 0 : N[T]) ? ue : 0,
                we = ve ? me : fe - S[ge] - D[ge] - ye + L.altAxis,
                Ee = ve ? fe + S[ge] + D[ge] - ye - L.altAxis : _e,
                ke =
                  _ && ve
                    ? (function (e, t, n) {
                        var i = V(e, t, n);
      ...
      class ln extends wt {
        ...
        _slide(e, t = null) {
          ...
          s.classList.add(c), Ze(s), n.classList.add(l), s.classList.add(l);
          this._queueCallback(
            () => {
      ...
      pt.on(document, fn, vn, function (e) {
        ...
        const t = Ne(this),
          n = Dt.find(t);
        for (const e of n) En.getOrCreateInstance(e, { toggle: !1 }).toggle();
      }),
        Ve(En);
      const kn = "dropdown",
        An = ".bs.dropdown",
        ...
        _getPlacement() {
          ...
          const t =
            ...
            getComputedStyle(this._menu)
              ...
              .trim();
          return e.classList.contains("dropup") ? (t ? zn : qn) : t ? Fn : Hn;
        }
        _detectNavbar() {
      ...
      class ui extends yt {
        ...
        _handleKeydown(e) {
          "Tab" === e.key &&
            (this._lastTabNavDirection = e.shiftKey ? li : "forward");
        }
      }
      const hi = ".bs.modal",
        pi = `hide${hi}`,
      ...
      class Ri extends wt {
        ...
        show(e) {
          ...
          if (
            pt.trigger(this._element, ji, { relatedTarget: e }).defaultPrevented
          )
            return;
          (this._isShown = !0),
            this._backdrop.show(),
      ...
      pt.on(document, Fi, '[data-bs-toggle="offcanvas"]', function (e) {
        const t = je(this);
        if (
          (["A", "AREA"].includes(this.tagName) && e.preventDefault(), He(this))
        )
          return;
        pt.one(t, zi, () => {
          ze(this) && this.focus();
        ...
        pt.on(window, Li, () => {
          for (const e of Dt.find(Ni)) Ri.getOrCreateInstance(e).show();
        }),
        pt.on(window, Hi, () => {
      ...
      const Ji = new Set([
        ...
        Ki = (e, t) => {
          ...
          return t.includes(n)
            ? !Ji.has(n) ||
                Boolean(Vi.test(e.nodeValue) || Ui.test(e.nodeValue))
      ...
      class hs extends wt {
        ...
        show() {
          ...
          const e = pt.trigger(
            ...
            t = (
              Fe(this._element) || this._element.ownerDocument.documentElement
            ...
            if ("click" === t)
              ...
              pt.on(this._element, e, this._config.selector, (e) => {
                ...
                pt.on(this._element, n, this._config.selector, (e) => {
                  const t = this._initializeOnDelegatedTarget(e);
                  (t._activeTrigger["focusout" === e.type ? ls : as] =
      ...
      class Rs extends wt {
        ...
        _keydown(e) {
          ...
          n &&
            (n.focus({ preventScroll: !0 }), Rs.getOrCreateInstance(n).show());
        }
        _getChildren() {
                ...
                datasets: [
                  {
                    label: "Projections",
                    data: [
                      12440, 15021, 10081, 10984, 8409, 12532, 13986, 19227,
                      12636, 10171, 6753, 15589,
                    ],
                  ...
                  },
                  {
                    label: "Actual",
                    data: [
                      12357, 13665, 9071, 9914, 5115, 12291, 10010, 19092,
                      11976, 9174, 5189, 14523,
                    ],
                ...
                datasets: [
                  {
                    ...
                    data: [
                      400, 1e3, 1e3, 2500, 3e3, 1500, 4e3, 5e3, 8e3, 6e3, 5500,
                      6500,
                    ],
                  },
                ],
            ...
            new Chart(Ao, {
              ...
              data: {
                ...
                datasets: [
                  {
                    data: [75, 25],
                    backgroundColor: [go.Z(`${bo}primary`), go.Z(`${bo}light`)],
                  },
                ],
              },
              options: {
                ...
                datasets: [
                  {
                    ...
                    data: [
                      9932, 7384, 6673, 4500, 3834, 1222, 2127, 3384, 2992,
                      5383, 1923, 2537,
                    ],
                    tension: 0,
                  },
                ...
                datasets: [
                  {
                    label: "Expected",
                    data: [
                      9440, 18021, 34081, 43804, 30409, 22532, 21986, 27227,
                      32636, 30171, 32753, 19589,
                    ],
                    borderColor: go.Z(`${bo}primary`),
                    pointRadius: 4,
                    pointBorderWidth: 3,
                  ...
                  },
                  {
                    label: "Actual",
                    data: [
                      2440, 9247, 23081, 30839, 39923, 36532, 28386, 34227,
                      38636, 37171, 25753, 25589,
                    ],
                    borderWidth: 2,
                    borderDash: [5, 5],
                ...
                datasets: [
                  {
                    label: "Revenue",
                    data: [
                      1534797, 1807907, 2991201, 3206722, 3400109, 4490270,
                      4811541, 5079186, 5416371, 5445881, 5285721, 5625865,
                      6689399, 7659140, 8811657, 8960763, 9335633, 9518522,
                      10975742, 12644259, 13035177, 13337221, 14407691,
                      15102984, 15140604, 15498567, 15582300, 16034956,
                      15600252, 17132937, 17277658, 17985396, 19104049,
                      19606166, 19641876, 19987294,
                    ],
                    borderWidth: 2,
                ...
                datasets: [
                  {
                    label: "Volume",
                    data: [
                      62818, 41778, 48100, 106833, 189364, 152544, 203980,
                      218007, 269406, 290798, 357599, 323096, 307246, 375954,
                      408444, 368624, 529254, 594473, 514196, 456412, 428602,
                      535077, 628141, 602323, 564725, 648952, 690027, 796537,
                      876486, 961475, 816575, 861616, 912809, 869996, 904038,
                      981902,
                    ],
                    backgroundColor: go.Z(`${bo}primary`),
                    barThickness: 10,
