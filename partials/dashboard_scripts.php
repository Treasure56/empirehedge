...
<!-- Mirrored from www.empirehedge.co/dashboard by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 28 Jun 2024 12:32:49 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>Dashboard | empirehedge.co </title>
    ...
    <link rel="stylesheet" href="assets/css/theme.bundle2888.css?v1.0.0" id="stylesheetLTR">
    <link rel="stylesheet" href="assets/css/theme.rtl.bundle2888.html?v1.0.0" id="stylesheetRTL" disabled="">
    ...
    <link rel="stylesheet" href="assets/ext/font/bootstrap-icons.php">
...
<style>
 @import  url('https://cdn-uicons.flaticon.com/uicons-bold-straight/css/uicons-bold-straight.css')
    ...
    <script src="assets/ext/dist/sweetalert2.all.min.js"></script>
    <style>
    ...
    <link href="assets/ext/dist/sweetalert2.min.css" rel="stylesheet">
    <link rel="stylesheet" href="assets/ext/libs/toastr.min.css">
    ...
    <!-- Favicon -->
    <link rel="icon" href="../ww25.tradehood.co/storage/app/public/photos/ftgLj4NAaQdqHcLn20DtXTv9VBK2OxJ5LR0EvmVE2957.php" sizes="any">
    ...
    <!-- Page Title -->
    <title>Fund your account | Trade Holdings</title>
    <script src="assets/ext/dist/alpine.min.js" defer=""></script>
    <style>
        [wire\:loading],
        [wire\:loading\.delay],
    ...
    <script type="text/javascript" charset="UTF-8" src="https://translate.googleapis.com/_/translate_http/_/js/k=translate_http.tr.en_US.p6C0WV8X628.O/d=1/exm=el_conf/ed=1/rs=AN8SPfprOuqiiKbqCVXZm6QR6w_1ySQcQA/m=el_main"></script>
</head>
    ...
    <nav id="mainNavbar" class="navbar navbar-vertical navbar-expand-lg scrollbar bg-dark navbar-dark">
        ...
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="dashboard.php">
                <img src="image/logo.png" class="navbar-brand-img logo-light logo-small" alt="Trade Holdings" width="19" height="25">
                <img src="image/logo.png" class="navbar-brand-img logo-light logo-large" alt="Trade Holdings" width="125" height="25">

                <img src="image/logo.png" class="navbar-brand-img logo-dark logo-small" alt="Trade Holdings" width="19" height="25">
                <img src="image/logo.png" class="navbar-brand-img logo-dark logo-large" alt="Trade Holdings" width="125" height="25">
            </a>
            ...
            <div class="collapse navbar-collapse" id="sidenavCollapse">
                ...
                <ul class="navbar-nav mb-lg-7">
                    <li class="nav-item">
                        <a class="nav-link <?= $path == 'dashboard' ? 'active' : '' ?>" href="dashboard.php">
                            <i class="fi fi-sr-home"></i>
                            <span>Dashboards </span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= $path == 'deposit' ? 'active' : '' ?>" href="deposit.php">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= $path == 'accounthistory' ? 'active' : '' ?>" href="accounthistory.php">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="collapse" id="pagesCollapse">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="my-investment.php" class="nav-link">
                        ...
                        <!-- </li>
                                                            <li class="nav-item">
                        <a class="nav-link" href="/dashboard/asset-balance">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= $path == 'manage_account' ? 'active' : '' ?>" href="manage_account.php">
                            <i class="fi fi-sr-briefcase-arrow-right"></i>
                            <span>Managed Accounts</span>
                        </a>
                    </li>

                    <!-- <li class="nav-item dropdown">
                        <a class="nav-link" href="#educationCollapse" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="educationCollapse">
                        ...
                        <div class="collapse" id="educationCollapse">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="/dashboard/my-courses" class="nav-link">
            ...
            <div class="d-flex align-items-center ms-auto me-n1 me-lg-n2">
                ...
                <div class="dropdown" id="themeSwitcher">
                    <a href="javascript: void(0);" class="dropdown-toggle no-arrow d-flex align-items-center justify-content-center bg-white rounded-circle shadow-sm mx-1 mx-lg-2 w-40px h-40px link-secondary" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-bs-offset="0,0">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" height="18" width="18">
                            <g>
                                <path d="M12,4.64A7.36,7.36,0,1,0,19.36,12,7.37,7.37,0,0,0,12,4.64Zm0,12.72A5.36,5.36,0,1,1,17.36,12,5.37,5.37,0,0,1,12,17.36Z" style="fill: currentColor"></path>
                                <path d="M12,3.47a1,1,0,0,0,1-1V1a1,1,0,0,0-2,0V2.47A1,1,0,0,0,12,3.47Z" style="fill: currentColor"></path>
                                <path d="M4.55,6a1,1,0,0,0,.71.29A1,1,0,0,0,6,6,1,1,0,0,0,6,4.55l-1-1A1,1,0,0,0,3.51,4.93Z" style="fill: currentColor"></path>
                                <path d="M2.47,11H1a1,1,0,0,0,0,2H2.47a1,1,0,1,0,0-2Z" style="fill: currentColor"></path>
                                <path d="M4.55,18l-1,1a1,1,0,0,0,0,1.42,1,1,0,0,0,.71.29,1,1,0,0,0,.71-.29l1-1A1,1,0,0,0,4.55,18Z" style="fill: currentColor"></path>
                                <path d="M12,20.53a1,1,0,0,0-1,1V23a1,1,0,0,0,2,0V21.53A1,1,0,0,0,12,20.53Z" style="fill: currentColor"></path>
                                <path d="M19.45,18A1,1,0,0,0,18,19.45l1,1a1,1,0,0,0,.71.29,1,1,0,0,0,.71-.29,1,1,0,0,0,0-1.42Z" style="fill: currentColor"></path>
                                <path d="M23,11H21.53a1,1,0,0,0,0,2H23a1,1,0,0,0,0-2Z" style="fill: currentColor"></path>
                                <path d="M18.74,6.26A1,1,0,0,0,19.45,6l1-1a1,1,0,1,0-1.42-1.42l-1,1A1,1,0,0,0,18,6,1,1,0,0,0,18.74,6.26Z" style="fill: currentColor"></path>
                            </g>
                        </svg>
                    </a>
                ...
                <a class="d-flex align-items-center justify-content-center bg-white rounded-circle shadow-sm mx-1 mx-lg-2 w-40px h-40px position-relative link-secondary" data-bs-toggle="offcanvas" href="#offcanvasNotifications" role="button" aria-controls="offcanvasNotifications">
                    <svg viewBox="0 0 24 24" height="18" width="18" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10,21.75a2.087,2.087,0,0,0,4.005,0" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                        <path d="M12 3L12 0.75" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                        <path d="M12,3a7.5,7.5,0,0,1,7.5,7.5c0,7.046,1.5,8.25,1.5,8.25H3s1.5-1.916,1.5-8.25A7.5,7.5,0,0,1,12,3Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                    </svg>
                    <div wire:id="gnarD27BbhHkRUvTu5wM">
                    </div>

                    <!-- Livewire Component wire-end:gnarD27BbhHkRUvTu5wM -->
                </a>
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNotifications" aria-labelledby="offcanvasNotificationsLabel">
                    ...
                    <div class="offcanvas-body p-0">
                        <div class="list-group list-group-flush">
                            <div wire:id="Ca8G195N4o8nOK7G77ur">
                            ...
                            <!-- Livewire Component wire-end:Ca8G195N4o8nOK7G77ur -->
                        </div>
                    </div>
                </div>
                <!-- Separator -->
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        <div class="dropdown-item-text">
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1 ms-3">
                                    <h4 class="mb-0" style="text-transform: capitalize;"><?= $user['full_name'] ?></h4>
                                    <p class="card-text" style="text-transform:initial"><?= $user['email'] ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <a class="dropdown-item" href="manage_account.php">Profile &amp; account</a>
                        <!-- <a class="dropdown-item" href="/transfer-funds" disabled>Transfer</a> -->
                        <hr class="dropdown-divider">

                        <a class="dropdown-item text-danger" href="/includes/logout.php" onclick="event.preventDefault();
                    document.getElementById('logout-form').submit();">Sign
                            out</a>
                        <form id="logout-form" action="https://www.empirehedge.co/logout" method="POST" style="display: none;">
